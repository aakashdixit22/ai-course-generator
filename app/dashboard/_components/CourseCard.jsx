...
function CourseCard({ course, refreshData }) {
  ...
  return (
    <div className='p-2 sm:p-3 md:p-4 flex justify-center'>
      <div className='relative bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 
        w-[250px] sm:w-[300px] md:w-[350px] lg:w-[400px] 
        h-[350px] sm:h-[400px] md:h-[450px] lg:h-[400px] overflow-hidden'>
        ...
        <Link href={'/course/' + course?.courseId} className='block h-full'>
          <div className='flex flex-col h-full'>
            ...
            <div className='p-3 sm:p-4 flex-1 flex flex-col justify-between'>
              <h1 className='text-base sm:text-lg md:text-xl font-medium line-clamp-2'>
                {course?.courseOutput?.courseName}
              </h1>
